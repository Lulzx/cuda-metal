...
- The typed shared-IR migration gate is not closed. With CUDA Clang 21-23, the
  reviewed 29-file production-metallib matrix is 29/29 for direct `.cu` and PTX
  through `cumetal-ir`, while the legacy PTX backend is 27/29 because it rejects

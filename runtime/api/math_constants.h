// math_constants.h — CUDA's table of exactly-rounded floating-point constants.
//
// Values are the bit patterns NVIDIA's header defines, not recomputed ones:
// CUDART_PI_F is the float nearest pi, CUDART_PI the double nearest pi, and the
// INF/NAN entries are the same builtins CUDA uses. GROMACS's pme_solve.cu and
// listed_forces_gpu_internal.cu include this for CUDART_PI_F.
#pragma once
...
#define CUDART_SQRT_HALF_LO (-4.833646656726456e-17)
...
#define CUDART_SQRT_2_OVER_PI 7.9788456080286536e-1

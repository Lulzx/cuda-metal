...
- Production-metallib source corpus with CUDA Clang 21/22: direct typed IR
  **9/23**, typed PTX **7/23**, legacy PTX **23/23**. CUDA Clang 23 currently
  reduces typed PTX to **6/23**.
